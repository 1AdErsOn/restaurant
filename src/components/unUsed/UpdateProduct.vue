<script setup>
import { ref } from 'vue'
import OwnModal from '../OwnModal.vue'

const props = defineProps(['identy'])
...
<template>
  <div class="col-xl-12">
    <OwnModal :show="props.identy" @close-modal="handleClose">
      <template #tittle> Editar Producto </template>
      <template #body>
        <!-- Form Group (Name)-->
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <select v-model="type" class="form-select" id="addType" @change="handleChange">
            <option value="">Seleciona un Tipo</option>
            <option value="consu">Consumible</option>
            <option value="alma">Almacenable</option>
        ...
        <div class="mb-3" v-else-if="typeMode == 'alma'">
          ...
          <!-- Form Group (Cantidad)-->
          <div class="mb-3" v-show="cant">
            <label class="small mb-1" for="addCant">Cantidad:</label>
            <input
              class="form-control"
              id="addCant"
              type="number"
        ...
        <!-- Form Group (Precio)-->
        <div class="mb-3">
          <label class="small mb-1" for="addPrice">Precio:</label>
          <input
            class="form-control"
            id="addPrice"
            type="number"
        ...
        <div class="mb-3">
          ...
          <select class="form-select">
            ...
            <option value="consu">Platos</option>
            <option value="alma">Bebidas</option>
            <option value="servi">Extras</option>
          </select>
        </div>
        <!-- Submit button-->
        <button class="btn btn-outline-primary" type="button">Actualizar Producto</button>
      </template>
    </OwnModal>
  </div>
</template>
